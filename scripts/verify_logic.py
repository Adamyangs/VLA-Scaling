...
# SharedAttn-M == Cascade-M (same expert, same cross-attn to VLM KV)
...
# ---- Test 5: CrossAttn Denoise — same as Cascade analytically ----
print("\n[Test 5] CrossAttn Denoise: analytically identical to Cascade")
